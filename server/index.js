...
// // because for every route we need to write a lot of code
// // and then for every request we need to check the method and then the route
// // so to make it easy we use express js
...
// app is basically that handler function
...
app.listen(8000, () => console.log("Server is running on port 8000")); // now using this we can run the server directly without creating http server explicitly
